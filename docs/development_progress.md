...
- **Stripe Payment Integration**: Configured direct Stripe Payment Link integration. Checkout links open the Stripe Payment Link in a new tab, backed by full Stripe payment disclosures across `terms/page.tsx`, `privacy/page.tsx`, and `refund/page.tsx`, with digital delivery and instant fulfillment terms.
